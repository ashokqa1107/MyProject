class DC_DeploymentPage {
    ...
    Deploymentstatus = "//tbody/tr/td[4]";
    ...
    scheduleStatusBtn = "(//div[@class='mat-radio-outer-circle'])"
    ...
    clickOnNowRadioBtn() {
      cy.xpath(this.multiScheNowBtn).eq(5).click({ force: true });
    }
    ...
    clickOnScheduleStatusBtn() {
      cy.xpath(this.scheduleStatusBtn).eq(8).click({ force: true });
    }
    ...
    clickOnRealTimeRadioBtn() {
      cy.get(this.realtimeRadioBtn).eq(4).click({ force: true });
    }
    ...
    clickonMultiSchetroRealTimeDropDown() {
      cy.get(this.hetro_Ispsdropdown).click()
    }
  ...
  export default new DC_DeploymentPage();
