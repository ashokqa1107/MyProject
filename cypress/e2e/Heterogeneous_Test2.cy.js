...
describe('Hetero_campaign_Specs', () => {
    ...
    let campaignName = 'Hetero_MS_011';

    before(() => {
        
        // cy.generateRandom3DigitString().then((randomString) => {
        //     campaignName = 'Hetero_MS_' + randomString;
    ...
    //5.Deployment(Test-2)
    it.only('Deploying Hetero Campaign-Test-3(Main)', () => {
        cy.fixture("standard_campaign").then((data) => {
            CampaignPage.searchCampaignName(campaignName);
            cy.wait(2000);
            CampaignPage.clickOnFirstCampaignInTable();
    ...
    it('Deploying Hetero Campaign-Test-4(Ftp_RealTime)', () => {
        ...
        cy.fixture("standard_campaign").then((data) => {
            ...
            H_DeploymentPage.selectListByIndex(36);
     ...
     //3.Deployment (Test-5)
     it.only('Deploying Hetero Campaign-Test1(Main_warmup)', () => {
